...
INSERT INTO `auth_user` VALUES (1,'pbkdf2_sha256$15000$S4TkDYmjUcyA$5QIkazF7WCJBKq3t23kHl+WI+w0sQpiERHbL7hNQ7c0=','2015-07-10 01:30:01',1,'admin','','','',1,1,'2015-06-16 04:23:24'),(2,'pbkdf2_sha256$15000$1TSfdwfmtSZZ$fXhO4y34r0SKjlnt/i4OYM1PoRGe/k/KKuM/vllICFA=','2015-06-16 05:27:33',0,'zhanghai','','','',1,1,'2015-06-16 05:27:05');
...
INSERT INTO `django_admin_log` VALUES (1,'2015-06-16 04:23:43','1','日记',1,'',7,1),(2,'2015-06-16 04:23:55','2','python',1,'',7,1),(3,'2015-06-16 04:24:20','1','python',1,'',8,1),(4,'2015-06-16 04:24:26','2','django',1,'',8,1),(5,'2015-06-16 04:25:54','1','第一篇博文',1,'',9,1),(6,'2015-06-16 05:27:05','2','zhanghai',1,'',3,1),(7,'2015-06-16 05:27:22','2','zhanghai',2,'Changed is_staff.',3,1),(8,'2015-06-16 05:57:28','2','第一篇博文',1,'',9,1),(9,'2015-06-16 05:59:01','2','django and tornado比较',2,'Changed title and content.',9,1),(10,'2015-06-16 05:59:01','2','django and tornado比较',2,'Changed title and content.',9,1),(11,'2015-06-16 07:23:46','2','django and tornado比较',2,'Changed content.',9,1),(12,'2015-06-17 06:05:38','3','日记1',1,'',9,1),(13,'2015-06-17 06:06:16','3','日记1',2,'Changed content.',9,1),(14,'2015-07-10 06:32:55','3','瞌睡',1,'',8,1),(15,'2015-07-10 06:33:00','4','日记2',1,'',9,1);
...
INSERT INTO `django_content_type` VALUES (1,'permission','auth','permission'),(2,'group','auth','group'),(3,'user','auth','user'),(4,'content type','contenttypes','contenttype'),(5,'session','sessions','session'),(6,'site','sites','site'),(7,'classify','zblog','classify'),(8,'tag','zblog','tag'),(9,'article','zblog','article'),(10,'log entry','admin','logentry'),(11,'photo classify','zblog','photoclassify'),(12,'photo','zblog','photo');
...
CREATE TABLE `zblog_photo` (
  ...
  `photo_classify_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `zblog_photo_fd5db417` (`photo_classify_id`),
  CONSTRAINT `zbl_photo_classify_id_65344a0eaf65c7d7_fk_zblog_photoclassify_id` FOREIGN KEY (`photo_classify_id`) REFERENCES `zblog_photoclassify` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `zblog_photoclassify`
--

DROP TABLE IF EXISTS `zblog_photoclassify`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `zblog_photoclassify` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(50) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `zblog_photoclassify`
--

LOCK TABLES `zblog_photoclassify` WRITE;
/*!40000 ALTER TABLE `zblog_photoclassify` DISABLE KEYS */;
/*!40000 ALTER TABLE `zblog_photoclassify` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2015-07-10 15:24:15
